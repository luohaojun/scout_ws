...
static cv::String weightpath ="/home/luo/scout_ws/src/scout_ros/offb/src/include/yolo/yolov7-tiny.weights";
static cv::String cfgpath ="/home/luo/scout_ws/src/scout_ros/offb/src/include/yolo/yolov7-tiny.cfg";
static cv::String classnamepath = "/home/luo/scout_ws/src/scout_ros/offb/src/include/yolo/coco.names";
...
int main(int argc, char** argv)
{
    ...
    cv::VideoWriter video("/home/luo/scout_ws/src/scout_ros/offb/src/include/yolo/tracking.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    cv::VideoWriter videoyolo("/home/luo/scout_ws/src/scout_ros/offb/src/include/yolo/yolo.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    cv::VideoWriter videogt("/home/luo/scout_ws/src/scout_ros/offb/src/include/yolo/gt.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    ...
    // ros::Publisher publish_obj_w = nh.advertise<geometry_msgs::PoseStamped>("/pose_w",1);
    ...
    while(ros::ok())
    {
        ...
        if(!frame.empty())
        {
            ...
            if (found)
            {
                ...
                ofstream save("/home/luo/scout_ws/src/scout_ros/offb/include/yolo/gt.txt", ios::app);
                save<<counter<<endl;
            ...
            if(temp.size()!=0)
            {
                for(auto stuff:temp)
                {
                    ...
                    if(stuff.classnameofdetection=="tvmonitor")
                    {
