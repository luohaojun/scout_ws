...
static cv::String weightpath ="/home/luo/temp_ws/src/AUTO/offb/src/include/yolo/yolov7-tiny.weights";
static cv::String cfgpath ="/home/luo/temp_ws/src/AUTO/offb/src/include/yolo/yolov7-tiny.cfg";
static cv::String classnamepath = "/home/luo/temp_ws/src/AUTO/offb/src/include/yolo/coco.names";
...
int main(int argc, char** argv)
{
    ...
    cv::VideoWriter video("/home/luo/temp_ws/src/AUTO/offb/src/include/yolo/tracking.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    cv::VideoWriter videoyolo("/home/luo/temp_ws/src/AUTO/offb/src/include/yolo/yolo.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    cv::VideoWriter videogt("/home/luo/temp_ws/src/AUTO/offb/src/include/yolo/gt.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    ...
    while(ros::ok())
    {
        ...
        if(!frame.empty())
        {
            ...
            if (found)
            {
                ...
                ofstream save("/home/luo/temp_ws/src/AUTO/offb/src/include/yolo/gt.txt", ios::app);
                save<<counter<<endl;
