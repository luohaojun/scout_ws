...
{
    ofstream save("/home/luo/scout_ws/src/scout_ros/offb/src/log/pooh_gt.txt",ios::app);
...
void pooh_percept()
{
    ...
    ofstream save("/home/luo/scout_ws/src/scout_ros/offb/src/log/serachpooh.txt",ios::app);
    save<<meaornot<<endl;
...
void err_cal()
{
    ...
    ofstream save("/home/luo/scout_ws/src/scout_ros/offb/src/log/err_xyz.txt",ios::app);
    save<<err_x<<endl;
    save<<err_y<<endl;
    save<<err_z<<endl;
    save.close();
