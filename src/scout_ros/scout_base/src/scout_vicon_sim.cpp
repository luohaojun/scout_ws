...
Vec2 des_pose(Vec3 UGV_pose_XYyaw, Vec3 obj_pose_XYZ)
{
    ...
    Vec2 des_pose;
    // des_pose[0] = obj_pose_XYZ[0]-(((dis_XY-des_dist_XY)/dis_XY)*(obj_pose_XYZ[0]-UGV_pose_XYyaw[0]));
    // des_pose[1] = obj_pose_XYZ[1]-(((dis_XY-des_dist_XY)/dis_XY)*(obj_pose_XYZ[1]-UGV_pose_XYyaw[1]));
